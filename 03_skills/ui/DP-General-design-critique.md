...
# `/design-critique` — Structured Critique of a UI or Prototype

## Purpose

Provides a structured, prioritized critique of a UI Studio design or prototype against Dialpad's design standards, accessibility requirements, and the JTBD/persona context from the PRD.
...
UI Studio link or prototype URL: [link]
...
[USER_INPUT — UI Studio link or screenshot description]
...
- Cannot see UI Studio files directly without UI Studio MCP configured (see `09_mcps/guides/DP-General-design-studio-setup.md`)
- Cannot verify Dialtone token usage in UI Studio without accessing the file — rely on screenshots for visual review
