...
# `/component-spec` — Produce a Component Spec from a UI Studio Frame or Description

## Purpose

Produces an engineering-ready component specification from a UI Studio frame description or screenshot. Spec includes component anatomy, props/variants, interaction states, accessibility requirements, and Dialtone component references.
...
UI Studio frame: [URL or paste description of what you see]
...
6. UI token references (from `01_context/design-system/DP-General-tokens.md`)
...
UI Studio/visual description: [USER_INPUT]
...
6. UI tokens: specific CSS custom properties for colors, spacing, typography
...
- Cannot see actual UI Studio files without UI Studio MCP configured
