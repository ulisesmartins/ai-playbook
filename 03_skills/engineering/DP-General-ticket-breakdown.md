...
Takes a JIRA epic (or epic description) and breaks it into stories that are correctly scoped for individual engineer sessions. Engineering-focused — considers implementation complexity, not just product scope.
...
- Story points set by Engineering during sprint planning — leave blank
