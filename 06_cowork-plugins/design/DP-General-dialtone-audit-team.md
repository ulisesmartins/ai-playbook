...
|---|---|---|
| Token Auditor | Design token compliance | Color, spacing, typography, shadow tokens; no hardcoded values |
...
3. Shares accessibility violations with Engineering for implementation review
