...
# Design Review Team — Multi-Role Design Critique Before Gate 2
...
| Dialtone Reviewer | Design system compliance | Token usage, component variants, pattern consistency |
...
Core Area: [CORE_AREA]
Design input: [FIGMA_URL_OR_DESCRIPTION]
...
3. Shares the consolidated report with PM and Engineering leads
