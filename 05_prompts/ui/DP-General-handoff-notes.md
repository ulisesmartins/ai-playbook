...
# UI Handoff Notes Prompt

## Purpose

Generate structured engineering handoff notes from an annotated UI Studio spec or component description. Covers component names, props, accessibility attributes, and interaction behavior — ready to paste into Confluence or a JIRA ticket.

## When to Use

- Gate 2 handoff to Coding
...
UI input:
[PASTE UI Studio screen annotations, component spec, or visual description here]
...
- Always specify the feature flag name — Coding needs this to scope their work
