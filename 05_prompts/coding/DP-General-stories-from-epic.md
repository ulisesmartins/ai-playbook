...
agent can execute it without ambiguity. Coding-focused decomposition — considers
...
- Flag any L story for Coding to split before sprint planning
...
- Cannot determine exact file paths — use `DP-General-index.md` as a guide; Coding confirms
- Story points are not set — Coding owns sizing during sprint planning
