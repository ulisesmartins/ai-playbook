...
Design Studio reference: [DESIGN_STUDIO_URL or "not available"]
...
| `[DESIGN_STUDIO_URL]` | Design Studio frame URL for reference | `https://dialpad.github.io/design-studio/#/` |
...
4. List of Dialtone tokens used (for Design review)
...
- Cannot guarantee pixel-perfect match to Design Studio without human design review
