...
In this section, a list of tools and resources related to the UI Workflow are shared. Empower your design journey and unlock your full potential!

The content is organized into the following areas:

<div class="grid cards" markdown>

-   :material-palette-outline:{ .lg .middle } **Figma at Dialpad**
...
!!! info "Source"
    ...
    This content is sourced from the [UI Confluence space](https://dialpad.atlassian.net/wiki/spaces/DES/pages/837943880). For the most up-to-date information, check Confluence directly.
