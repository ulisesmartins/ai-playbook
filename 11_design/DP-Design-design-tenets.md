---
title: Design Tenets
description: Seven decisive rules for making trade-off decisions faster and more consistently across the Design team.
---

# Design Tenets Framework

The Design Tenets framework is a set of seven specific, decisive rules the Design team should use to make trade-off decisions faster and more consistently, especially when there are multiple equally valid approaches and the team needs a clear way to break ties.

## Principles vs. Tenets

- **Design Principles** answer: *What do we believe in?* — foundational beliefs that guide philosophy but often don't resolve trade-offs
- **Design Tenets** answer: *When we have to choose, which path do we take?* — specific rules that intentionally choose a consistent trade-off

## The Seven Design Tenets

### 1. Design systems, not surfaces

Features should exist where people need them, not where the team decides to place them. Design should follow the user's path rather than forcing users to follow the product's structure.
...
- FY26 Q4 Design All Hands Recording
- FY26 Q4 Design All Hands Deck
- [Lenny's Podcast: 35 years of product design wisdom](https://www.lennysnewsletter.com/) from Apple, Disney, Pinterest and beyond

*For feedback or questions about Design Tenets, contact Joshua Hynes.*

---

!!! info "Source"

    This content is sourced from [Design Tenets Framework](https://dialpad.atlassian.net/wiki/spaces/DES/pages/2354610325) on Confluence.
