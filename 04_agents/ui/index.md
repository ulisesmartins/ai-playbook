...
-   :material-weather-sunny:{ .lg .middle } **Start Day**
    ...
    Morning design kickoff — pulls UI Studio comments, surfaces open critique threads, and sets your design focus for the day.
...
-   :material-check-decagram:{ .lg .middle } **Dialtone Audit**
    ...
    Audits UI Studio files or component specs for DT9 compliance — flags color, typography, component, spacing, and icon violations with severity ratings.
...
-   :material-timer-sand:{ .lg .middle } **Long-term UI Agent**
