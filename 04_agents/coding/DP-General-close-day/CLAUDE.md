...
change_summary: "Initial version — Coding end-of-day capture, implementation decision logging, PR status, and standup draft"
status: GA
audience: Coding
---

# Coding Close Day Agent
...
```markdown
---
source: Coding Close Day Agent
date: [YYYY-MM-DD]
next_step: Coding Start Day (04_agents/engineering/DP-General-start-day/)
---
